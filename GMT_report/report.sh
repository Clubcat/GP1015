...
gmt psbasemap -R120/122/0/63 -Jx3/-0.01 -BwEsN  -X3 -Y24  -O -K >> $out_ps
echo "121 22 History Earthquake" | gmt pstext -R -J -F+f,Helvetica-Bold,black -O -K >> $out_ps

# Right map
gmt psbasemap -R0/315/21/26 -Jx0.01/3.25 -Bxa100f20 -Bya1f1 -X11 -Y-19 -O -K >> $out_ps
